...
//Filas
            if (_Tablero[0][0] == i && _Tablero[0][1] == i && _Tablero[0][2] == i) {
                _Boton_Arriba_Izquierda.setBackgroundResource(i == CASILLA_JUGADOR_1 ?
                        R.mipmap.circulo_gano : R.mipmap.x_gano);
            ...
            //Columnas
/*Agregue el código para validar las columnas*/
//Diagonales
/*Agregue el código para validar las diagonales*/
            ...
            public void onClick(View v) {
                if (!_FinPartida && _TotalMovimientos <= CANTIDAD_MAXIMA_JUGADAS &&
                    ...
                    _Tablero[_Fila][_Columna] = _Turno ? CASILLA_JUGADOR_1 :
                            CASILLA_JUGADOR_2;
                    _Boton.setBackgroundResource(_Turno ? R.mipmap.circulo : R.mipmap.x);
                    _TotalMovimientos++;
